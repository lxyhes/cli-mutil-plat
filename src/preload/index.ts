...
if (!ctxBr) {
  ...
  team: {
    ...
    retryTask: (teamId: string, taskId: string, options?: { memberId?: string; note?: string }) => ipcRenderer.invoke(IPC.TEAM_RETRY_TASK, teamId, taskId, options),
    ...
    updateMember: (teamId: string, memberId: string, updates: any) => ipcRenderer.invoke(IPC.TEAM_UPDATE_MEMBER, teamId, memberId, updates),
  ...
  codeGraph: {
    ...
    ask: (projectPath: string, question: string, options?: any) =>
      ipcRenderer.invoke(IPC.CODE_GRAPH_ASK, projectPath, question, options),
  },
