...
function ProviderBadge({ providerId }: { providerId: string }) {
  ...
  return (
    <div className="relative group inline-block">
      ...
      {/* Tooltip */}
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 px-2 py-1 bg-zinc-800 border border-zinc-700 text-zinc-300 text-xs rounded whitespace-normal max-w-[200px] opacity-0 group-hover:opacity-100 transition-opacity z-20 pointer-events-none shadow-lg">
        {config.tooltip}
        {/* 小三角 */}
